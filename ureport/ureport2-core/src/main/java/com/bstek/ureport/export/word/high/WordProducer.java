...
public class WordProducer implements Producer{
			...
			for(Page page:pages){
				...
				for(int rowNumber=0;rowNumber<rows.size();rowNumber++){
					...
					for(Column col:columns){
						...
						buildTableCellStyle(table,tableCell,cell,rowNumber,colNumber, report);
					}
				}
	...
	private void buildTableCellStyle(XWPFTable table,XWPFTableCell tableCell,Cell cell,int rowNumber,int columnNumber, Report report){
