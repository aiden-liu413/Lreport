...
public class SHA1withDSA_SignatureImpl extends Signature {
	 ...
	 *
	 * @throws InvalidKeyException if privateKey is not DSAPrivateKey object
	 * @params privateKey DSAPrivateKey object
	 */
	 ...
	 * passed as argument to the method.
	 *
	 * @throws InvalidKeyException if publicKey is not DSAPublicKey object
	 * @params publicKey DSAPublicKey object
	 */
	 ...
	 *
	 * @return byte array containing signature in ASN1 representation
	 * @throws SignatureException if object's state is not SIGN or
	 ...
	 *
	 * @throws SignatureException if object was not initialized for signing or verifying
	 * @params b byte array containing bytes to update
	 * @params off offset in byte array to start from
	 * @params len number of bytes to use for updating
	 */
	 ...
	 *
	 * @return true if signature bytes were verified, false otherwise
	 * @throws SignatureException if object's state is not VERIFY or
	 *                            signature format is not ASN1 representation or
	 *                            signature algorithm cannot process data
	 * @params sigBytes byte array with signature bytes to verify.
	 */
	 ...
	 *                            signature algorithm cannot process data
	 * @params sigBytes byte array with signature bytes to verify.
	 * @params offset index in sigBytes to start from
	 * @params length number of bytes allotted for signature
	 */
