...
public class SHA1PRNG_SecureRandomImpl extends SecureRandomSpi implements
	 ...
	 *
	 * @param numBytes - number of bytes to return; should be >= 0.
	 * @return byte array containing bits in order from left to right
	 * @throws InvalidParameterException - if numBytes < 0
	 */
